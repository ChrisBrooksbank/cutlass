  ...
  removeTrack: (trackId) => {
    set((state) => {
      ...
      return {
        ...
        selection: {
          ...state.selection,
          selectedClipIds: state.selection.selectedClipIds.filter((id) => !removedClipIds.has(id)),
          selectedTrackId:
            state.selection.selectedTrackId === trackId ? null : state.selection.selectedTrackId,
        },
      }
    })
  },
