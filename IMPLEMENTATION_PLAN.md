...
- [ ] Trim handles: drag left/right clip edges to adjust in/out points (spec: timeline-editing.md)
- [ ] Draggable playhead that snaps to clip boundaries and syncs preview position (spec: timeline-editing.md)
- [ ] Split tool: split clip at playhead into two independent clips (spec: timeline-editing.md)
...
- [ ] Screen capture via getDisplayMedia (video + system audio); start/pause/resume/stop controls + timer UI (spec: recording.md)
...
- [ ] Web Audio API routing graph: each track through GainNode to destination (spec: audio.md)
...
- [ ] Keyframe data model: per-effect keyframes with easing types (linear, ease-in, ease-out, ease-in-out) (spec: effects-annotations.md)
- [ ] Keyframe editor UI in properties panel: add/remove/move keyframes, easing curve selector (spec: effects-annotations.md)
- [ ] Effect registry: extensible map of effect-type → render/export handler (spec: effects-annotations.md)
